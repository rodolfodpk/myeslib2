...
public class JdbiUnitOfWork implements UnitOfWork {
    ...
    private final JdbiUnitOfWorkId id;
    private final JdbiCommandId commandId;
    private final Long version;
    private final List<? extends Event> events;

    JdbiUnitOfWork(JdbiUnitOfWorkId id, JdbiCommandId commandId, Long version, List<? extends Event> events) {
        this.id = id;
    ...
    public static UnitOfWork create(JdbiUnitOfWorkId id, JdbiCommandId commandId, Long snapshotVersion, List<? extends Event> newEvents) {
