...
@Immutable
@Deprecated
public class JdbiGsonSnapshot<A extends AggregateRoot> implements Snapshot {

    static final Logger logger = LoggerFactory.getLogger(JdbiGsonSnapshot.class);
    ...
    public JdbiGsonSnapshot(Class<A> clazz, A aggregateInstance, Long version, Gson gson) {
        checkNotNull(clazz);
        this.clazz = clazz;
    ...
    public boolean equals(Object o) {
        ...
        JdbiGsonSnapshot snapshot = (JdbiGsonSnapshot) o;
