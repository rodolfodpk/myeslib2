...
public class Stack1GsonSnapshotTest {
    ...
    public void getAggregateInstance() throws Exception {
        ...
        Snapshot<InventoryItem> snapshot = new Stack1GsonSnapshot<>(InventoryItem.class, item, 1L, gson);
    ...
    public void equals() throws Exception {
        InventoryItem item = InventoryItem.builder().id(UUID.randomUUID()).description("item4test").available(0).build();
        Snapshot<InventoryItem> snapshot = new Stack1GsonSnapshot<>(InventoryItem.class, item, 1L, gson);
        assertThat(snapshot, is(new Stack1GsonSnapshot<>(InventoryItem.class, item, 1L, gson)));
    }
