...
@Immutable
public class Stack1UnitOfWork implements UnitOfWork {

    private final Stack1UnitOfWorkId id;
    private final Stack1CommandId commandId;
    private final Long version;
    private final List<? extends Event> events;

    Stack1UnitOfWork(Stack1UnitOfWorkId id, Stack1CommandId commandId, Long version, List<? extends Event> events) {
        this.id = id;
    ...
    public static UnitOfWork create(Stack1UnitOfWorkId id, Stack1CommandId commandId, Long snapshotVersion, List<? extends Event> newEvents) {
        ...
        return new Stack1UnitOfWork(id, commandId, snapshotVersion + 1, newEvents);
    }
    ...
    public boolean equals(Object o) {
        ...
        Stack1UnitOfWork that = (Stack1UnitOfWork) o;
